        ...
        <div class="modal-content">
          ...
          <hr>
            <div id="add_class_form">
              ...
              <input class="form-control" name="code" placeholder="Code , Eg : CIT-322">
              ...
              <input class="form-control" name="start" placeholder="Starting Matric Number (Eg. 201/CO/12)">
              <input class="form-control" name="end" placeholder="Ending Matric Number (Eg. 265/CO/12)">
